Для создания документации с помощью Doxygen, необходимо добавить комментарии в формате Doxygen перед объявлениями классов, методов и переменных. Вот пример, как это можно сделать для вашего кода:
